    ...
    content = (
      <>
        <CardItem
          ...
          card={dashboardOrderAmount?.todayCardPaymentAmount as number} 
          cash={dashboardOrderAmount?.todayCashPaymentAmount as number} 
          icon={<Received />}
          clr=""
          clr2="bg-success"
        />
        <CardItem
          ...
          card={dashboardOrderAmount?.yesterDayCardPaymentAmount as number}
          cash={dashboardOrderAmount?.yesterDayCashPaymentAmount as number}
          icon={<Sales />}
